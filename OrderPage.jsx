            ...
            {/* THIS IS FOR FRIES */}
             ...
             {Item==="Desert"&&(
               ...
               <div class="box">
                 <h1>{milkShakes[0]}</h1>
                   <div class="quantity-row">
                       <button class="defButton"   onClick={()=>{DecrementMilkShakes(0)}}>-</button>
                       <h2>{milkShakesQuantity[0]}</h2>
                       <button class="defButton"  onClick = {() =>{IncrementMilkShakes(0)}} >+</button>
                     </div>  
               </div>
               ...
               <div class="box">
                 <h1>{milkShakes[1]}</h1>
                   <div class="quantity-row">
                       <button class="defButton"   onClick={()=>{DecrementMilkShakes(1)}}>-</button>
                       <h2>{milkShakesQuantity[1]}</h2>
                       <button class="defButton"   onClick={()=>{IncrementMilkShakes(1)}}>+</button>
                     </div>  
               </div>
               ...
               <div class="box">
                 <h1>{milkShakes[2]}</h1>
                   <div class="quantity-row">
                       <button class="defButton"   onClick={()=>{DecrementMilkShakes(2)}}>-</button>
                       <h2>{milkShakesQuantity[2]}</h2>
                       <button class="defButton"  onClick={()=>{IncrementMilkShakes(2)}}>+</button>
                     </div>  
               </div>
               ...
               <div class="box">
                 <h1>{milkShakes[3]}</h1>
                   <div class="quantity-row">
                       <button class="defButton"    onClick={()=>{DecrementMilkShakes(3)}}>-</button>
                       <h2>{milkShakesQuantity[3]}</h2>
                       <button class="defButton"    onClick={()=>{IncrementMilkShakes(3)}}>+</button>
                     </div>  
               </div>
               </div>
                </>
